        ...
        if submission and "grade" in submission:
            ...
            if csv_grade > current_grade or current_grade == 0:
                if csv_grade * 0.8 > current_grade:
                    ...
                    print(
                        f"Current Grade: {current_grade}, New Grade: {csv_grade}. Applied late penalty. Updated grade for student {student['sortable_name']}"
                    )
                    ...
                    print(
                        f"Grade for student {student['sortable_name']} is lower than 80% of the original grade"
                    )
            else:
                print(
                    f"Current Grade: {current_grade}, New Grade: {csv_grade}. No late penalty applied. Grade not updated for student {student['sortable_name']}"
                )
        else:
